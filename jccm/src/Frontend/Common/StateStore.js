...
const useStore = create((set, get) => ({
    ...
    deviceErrorCache: {},
    setDeviceErrorCacheAll: (value) =>
        set((state) => ({
            deviceErrorCache: value,
        })),

    setDeviceErrorCache: (path, value) =>
        set((state) => ({
            deviceErrorCache: { ...state.deviceErrorCache, [path]: value },
        })),
    resetDeviceErrorCache: (path) =>
        set((state) => {
            const { [path]: _, ...rest } = state.deviceErrorCache;
            return { deviceErrorCache: rest };
        }),
    zeroDeviceErrorCache: () =>
        set((state) => {
